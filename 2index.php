<?php 
ob_start(); 
$conn = new mysqli('localhost','root','','tmpd');
...
@media screen and (max-width: 3000px) {
	body{
		...
		/*background-image: url("bg_login.jpg"); */
		/*background: linear-gradient(to bottom left, #009999 0%, #009933 100%);*/
	}
	.container{	
...
<center>
	<div class="container">
		...
		<div class="box">
			<form method="post">
				<div class="title">ระบบจัดการและติดตามเอกสาร<br>โรงพยาบาลค่ายจักรพงษ์</div><br>
				...
				<!-- <div class="forgot"><a href=""style="text-decoration-line: none;color: black;">จำรหัสผ่านไม่ได้ ?</a></div> -->
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        ...
		        <input type="submit" class="btn btn-primary" name="btn_forgot" value="ยืนยัน">
			    </form>
		      </div>
		    </div>
		  </div>
