...
<style type="text/css">
	...
	input[type=text]{
	    /*padding: 5px 10px;border-radius: 4px;border-width: 1px;background-color: #373737;border-color: black; border-style: solid;*/
	}
</style>
	  ...
	  <thead>
	  	...
	  	<tr>	
	  		<td colspan="3">
	  			...
	  			<?php 
	  				// $ChkLength = 0;
	  			while($rwSDetail2=$rsSDetail2->fetch_assoc()){

	  				// $ChkLength++;
	  				?>
	  				<option value="<?php echo $rwSDetail2['step_detail_id']; ?>"><?php echo $rwSDetail2['document_name']; ?></option>
	  			<?php } ?>
		  			...
		  			<input type="submit" name="" onclick="return confirm('ยืนยันการอัพโหลดไฟล์');" value="Upload">
		  		</form>
	  		</td>
	  	</tr>
	  	<tr>
						        			...
						        			if($rsActDetail->num_rows>0){
						        				...
						        				while($rwActDetail = $rsActDetail->fetch_assoc()){
						        					...
						        					<tr>
														...
														<td><a href="../file_upload/<?php echo $rwActDetail['user_doc']; ?>"><?php echo $rwActDetail['user_doc']; ?></a></td>
														<td>
															<form method="POST" action="" id="del<?php echo $rwActDetail['activity_detail_id']; ?>">
																...
																<input type="submit" name="btn_del" value="ลบเอกสาร">
															</form>
														</td>
						        					</tr>
						        					<?php
